 ...
 */
!function(e,n,t){"use strict";var r=n.module("LocalForageModule",["ng"]);r.provider("$localForage",function(){t.config({name:"lf"}),this.notify={setItem:!1,removeItem:!1};var e=function(e){return t.setDriver(e)};this.setDriver=e;var r=function(){return t.driver()};this.setNotify=function(e,n){this.notify={setItem:e,removeItem:n}},this.config=function(r){return n.isObject(r)||(r={}),n.isDefined(r.driver)?(t.config(r),e(r.driver)):t.config(r)},this.$get=["$rootScope","$q","$parse",function(i,o,a){var u=this.notify,c={},s=function(){return"localStorageWrapper"===r()?t.config().name+".":""},f=function(t,i,o,a){(n.isObject(t)&&t.name?"InvalidStateError"===t.name:n.isString(t)&&"InvalidStateError"===t)&&"asyncStorage"===r()||n.isObject(t)&&t.code&&5===t.code?e("localStorageWrapper").then(function(){o.apply(this,i).then(function(e){a.resolve(e)},function(e){a.reject(e)})},function(){a.reject(t)}):a.reject(t)},l=function(e,r){var a=o.defer(),c=arguments,d=n.copy(r);return n.isObject(d)&&n.isDefined(d.$promise)&&delete d.$promise,t.setItem(s()+e,d).then(function(){u.setItem&&i.$broadcast("LocalForageModule.setItem",{key:e,newvalue:d,driver:t.driver()}),a.resolve(d)},function(e){f(e,c,l,a)}),a.promise},d=function(e){var n=o.defer(),r=arguments;return t.getItem(s()+e).then(function(e){n.resolve(e)},function(e){f(e,r,d,n)}),n.promise},v=function(e){var n=t.removeItem(s()+e);return u.removeItem?n.then(function(){i.$broadcast("LocalForageModule.removeItem",{key:e,driver:t.driver()})}):n},m=function(){var e=o.defer(),t=arguments,r=[];return y().then(function(t){n.forEach(t,function(e){r.push(v(e))}),o.all(r).then(function(){e.resolve()})},function(n){f(n,t,m,e)}),e.promise},g=function(e){var n=o.defer(),r=arguments;return t.key(e).then(function(e){n.resolve(e)},function(e){f(e,r,g,n)}),n.promise},h=function(){var e=o.defer(),n=arguments;return t.length().then(function(n){e.resolve(n)},function(t){f(t,n,h,e)}),e.promise},y=function(){var e=o.defer(),n=arguments;return t.keys().then(function(n){for(var t=s(),r=[],i=0,o=n.length;o>i;i++)n[i]&&0===n[i].indexOf(t)&&r.push(n[i].substr(t.length,n[i].length));e.resolve(r)},function(t){f(t,n,y,e)}),e.promise},p=function(e,t){if(n.isString(t))t={key:t};else if(!n.isObject(t)||n.isUndefined(t.key))throw"You must defined a key to bind";var r={defaultValue:"",storeName:""};t=n.extend(r,t||{});var i=t.storeName||t.key,o=a(i);return d(i).then(function(r){return r?o.assign(e,r):t.defaultValue&&l(i,t.defaultValue),n.isDefined(c[t.key])&&c[t.key](),c[t.key]=e.$watch(a(t.key),function(e){n.isDefined(e)&&l(i,e)},!0),r})},k=function(e,t,r){r=r||t,a(t).assign(e,null),n.isDefined(c[t])&&(c[t](),delete c[t]),v(r)};return{setDriver:e,driver:r,getDriver:r,setItem:l,set:l,getItem:d,get:d,remove:v,removeItem:v,clear:m,clearAll:m,key:g,getKeyAt:g,keys:y,getKeys:y,length:h,getLength:h,bind:p,unbind:k}}]}),r.directive("localForage",["$localForage",function(e){return{restrict:"A",link:function(t,r,i){var o=t.$eval(i.localForage);n.isObject(o)&&n.isDefined(o.key)&&n.isDefined(o.storeName)?e.bind(t,o):e.bind(t,i.localForage)}}}])}(window,window.angular,window.localforage);